 ...
 * 
 * @see com.orderFoods.DAO.Customer
...
public class CustomerDAO {
	...
	public Customer findById(java.lang.Integer id) {
		...
		try {
			Customer instance = (Customer) getCurrentSession().get(
					"com.orderFoods.bean.Customer", id);
			return instance;
		} catch (RuntimeException re) {
	...
	public List findByExample(Customer instance) {
		...
		try {
			List results = getCurrentSession()
					.createCriteria("com.orderFoods.bean.Customer")
	...
	public Customer merge(Customer detachedInstance) {
		...
		try {
			Customer result = (Customer) getCurrentSession().merge(
					detachedInstance);
